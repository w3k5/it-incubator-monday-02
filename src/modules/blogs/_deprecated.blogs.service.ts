...
@injectable()
export class _deprecatedBlogsService implements AbstractBlogService {
	constructor(
	...
	public async updateBlogById(id: ModelID, data: _deprecatedUpdateBlogRepositoryDto): Promise<boolean> {
